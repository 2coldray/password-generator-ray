...
The password generator web application generates a random password of a length between 8 and 128 characters with a mix of uppercase, lowercase, numbers, and special characters. The user can customize the password to their liking meaning they don't have have a mix of all the characters types, but they must choose at least one to generate a password. 
...
5. The password generator will then display a password in the box.

## Usage

This is the home screen of the application. The password will appear in the prompt.

![Screen Shot 2020-09-03 at 8 10 43 PM](https://user-images.githubusercontent.com/60899926/92186403-a6080c00-ee24-11ea-8f75-ad4ca5b4c8ce.png)

This question asks how long you want the password to be.
...
## Credits
I used the documentation from MDN web docs: https://developer.mozilla.org/en-US/ for the code. I also used the TA's in office hours when I had questions.
...
## Badges
![badmath](https://img.shields.io/badge/HTML-100%25-red)

![badmath](https://img.shields.io/badge/CSS-100%25-red)

![badmath](https://img.shields.io/badge/Javascript-100%25-red)